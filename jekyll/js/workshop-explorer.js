(function () {
    ...
    var STATE_KEYS = ["workshop", "destination", "customDestination", "participants", "groupType", "international"];
    ...
    function stateFromUrlOnly() {
        return Object.assign(emptyState(), readUrlState());
    }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function commit(eventName, details, method) {
            render();
            var url = stateUrl(state, "#workshop-finder", true);
        ...
        function scrollAndFocus(shouldFocus) {
            ...
            explorer.style.scrollMarginTop = (navHeight + 18) + "px";
        ...
        if (window.location.hash === "#workshop-finder" || state.mode === "plan") {
