...
function MechanicalEngineeringFeedbackSurvey() {
  ...
  useEffect(() => {
    document.title = 'Mechanical Engineering Workshop Feedback Survey'
  }, [])
      ...
      <div className="app">
        <header className="header-bar">
          <div className="header-left">
            <span><strong>STAGE ONE EDUCATION</strong><span className="header-separator"> | </span><span className="survey-name">Mechanical Engineering Workshop Survey</span></span>
          </div>
      ...
      <main className="main-content">
        <form className="survey-form" onSubmit={handleSubmit}>
          <div className="survey-title-section">
            <h1>Mechanical Engineering Workshop<br /><span className="feedback-survey-text">Feedback Survey</span><span className="thank-you-text">Thank you for your feedback. Your responses are anonymous and help us improve future workshops.</span></h1>
          </div>
          {/* Location Question */}
